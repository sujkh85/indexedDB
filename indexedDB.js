...
IndexedDB.init = function(IDBSetting) {
...
IndexedDB.addData("Contact", {
    phone_no : "010-0000-0000",
	name : "sujkh85"
	id : "jkh"
})

IndexedDB.getAllData("Record",function(result){console.log(result)});
IndexedDB.getAllData("Contact",function(result){console.log(result)});
